  ...
  return (
    ...
    <div className="landing-page-right-side">
      <div className="landing-page-links-container">
        <span className="landing-page-text"><NavLink to="/" exact="true" className='header-links'  >Home</NavLink></span>
        <span className="landing-page-text01"><NavLink to="/About" className='header-links'  >About</NavLink></span>
        <span className="landing-page-text02"><NavLink to="/Destination" className='header-links'  >Destinations</NavLink></span>
        <span className="landing-page-text03"><NavLink to="/Gallary" className='header-links'  >Gallary</NavLink></span>
        <span className="landing-page-text03"><NavLink to="/Contact" className='header-links'  >Contact</NavLink></span>
      </div>
      <Link to="/Destination"><SolidButton button="Explore places"></SolidButton></Link>
    </div>
    <div className="landing-page-burger-menu"  onClick={()=>setOpenMenu(true)}>
    ...
    <div data-role="MobileMenu" className="landing-page-mobile-menu" style={{display:openMenu?"block":"none"}}>
      <div className="landing-page-nav">
        <div className="landing-page-top">
        <Link to='/'> <img src={logo} alt="goKoraput" style={{    width: "110px"}} title='Go-Koraput'  width="100%" height="100%"/></Link>
          <div
            data-role="CloseMobileMenu"
            className="landing-page-close-menu" onClick={()=>setOpenMenu(false)}
          >
